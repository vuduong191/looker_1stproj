  ...
  derived_table: {
    ...
    create_process: {
      sql_step: CREATE TABLE ${SQL_TABLE_NAME} as
        SELECT product_variant.sku AS product_variant_sku, MAX(product_variant.inventory_quantity) AS inventory_quantity, CURRENT_DATE("America/Los_Angeles") AS day
